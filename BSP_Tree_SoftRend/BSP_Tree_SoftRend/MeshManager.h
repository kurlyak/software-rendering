...
public:
	...
	vector4 m_Right = vector4(0.0f, 0.0f, 0.0f);
	vector4 m_Up = vector4(0.0f, 0.0f, 0.0f);
	vector4 m_Look = vector4(0.0f, 0.0f, 0.0f);
	vector4 m_Pos = vector4(0.0f, 0.0f, 0.0f);
