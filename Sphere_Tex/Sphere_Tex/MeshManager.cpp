...
void CMeshManager::Init_Sphere(HWND hWnd)
{
	m_hWnd = hWnd;
...
void CMeshManager::Calculate_Sphere()
{
    ...
    */
	...
	{
		vector3 Vec1, Vec2;
		Vec3_Mat4x4_Mul(Vec1, m_VertBuff[i], MxRotateX);
		Vec3_Mat4x4_Mul(Vec2, Vec1, MxRotateY);
		Vec3_Mat4x4_Mul(Vec1, Vec2, MxWorld);
